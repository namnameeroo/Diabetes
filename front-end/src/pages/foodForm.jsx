...
const getGl = (inputs) => {
  ...
  */
  ...
  let result = 3.2+(0.393566429*(newInputs.carbohydrate-newInputs.fiber))-(0.205486363*newInputs.fat)-(0.006877061*newInputs.protein*newInputs.protein)-(0.012675566*newInputs.fiber*newInputs.fiber)
...
const InputForm = () => {
  ...
  return (
    <>
              ...
              <tr>
                ...
                <td>
                  <InputCell
                    ...
                    types="number"
                    onChangeInput={onChangeInputForNum}
                    value={inputs.intake ? inputs.intake : 0}
                  />
                </td>
              </tr>
              <tr>
      ...
      <ResultToggle onToggle={onToggle} open={toggleOpen} result={inputs.result + " " + inputs.gl}>결 과 보 기</ResultToggle>
